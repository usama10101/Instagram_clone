      ...
      body: SafeArea(
        child: Padding(
          ...
          child: SingleChildScrollView(
            child: Column(
              mainAxisSize: MainAxisSize.min, // Ensures the column size is minimal
              children: [
                SizedBox(
                ...
                const SizedBox(height: 32), // Space between illustration and text
                ErrorInfo(
                  title: "No Results!",
                  description:
...
class ErrorInfo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Center(
      child: Container(
        constraints: const BoxConstraints(maxWidth: 400), // Ensure max width for better layout
          ...
          children: [
            ...
            button ??
                ElevatedButton(
                  ...
                  child: Text(btnText?.toUpperCase() ?? "Retry"),
                ),
            const SizedBox(height: 16),
          ],
        ),
